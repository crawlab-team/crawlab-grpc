...
var file_services_model_base_service_proto_rawDesc = []byte{
	...
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x32, 0xfe, 0x03, 0x0a, 0x10, 0x4d, 0x6f, 0x64, 0x65, 0x6c,
	...
	0x22, 0x00, 0x12, 0x29, 0x0a, 0x06, 0x49, 0x6e, 0x73, 0x65, 0x72, 0x74, 0x12, 0x0d, 0x2e, 0x67,
	...
	0x05, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x0d, 0x2e, 0x67, 0x72, 0x70, 0x63, 0x2e, 0x52, 0x65,
	0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x0e, 0x2e, 0x67, 0x72, 0x70, 0x63, 0x2e, 0x52, 0x65, 0x73,
...
var file_services_model_base_service_proto_depIdxs = []int32{
	...
	0,  // 9: grpc.ModelBaseService.Insert:input_type -> grpc.Request
	0,  // 10: grpc.ModelBaseService.Count:input_type -> grpc.Request
	1,  // 11: grpc.ModelBaseService.GetById:output_type -> grpc.Response
	1,  // 12: grpc.ModelBaseService.Get:output_type -> grpc.Response
	1,  // 13: grpc.ModelBaseService.GetList:output_type -> grpc.Response
	1,  // 14: grpc.ModelBaseService.DeleteById:output_type -> grpc.Response
	1,  // 15: grpc.ModelBaseService.Delete:output_type -> grpc.Response
	1,  // 16: grpc.ModelBaseService.DeleteList:output_type -> grpc.Response
	1,  // 17: grpc.ModelBaseService.ForceDeleteList:output_type -> grpc.Response
	1,  // 18: grpc.ModelBaseService.UpdateById:output_type -> grpc.Response
	1,  // 19: grpc.ModelBaseService.Update:output_type -> grpc.Response
	1,  // 20: grpc.ModelBaseService.Insert:output_type -> grpc.Response
	1,  // 21: grpc.ModelBaseService.Count:output_type -> grpc.Response
