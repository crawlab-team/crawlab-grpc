...
var file_services_node_service_proto_rawDesc = []byte{
	...
	0x22, 0x0e, 0x0a, 0x0c, 0x4e, 0x6f, 0x64, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65,
	0x22, 0x39, 0x0a, 0x08, 0x4e, 0x6f, 0x64, 0x65, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x10, 0x0a, 0x03,
	0x6b, 0x65, 0x79, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x6b, 0x65, 0x79, 0x12, 0x1b,
	0x0a, 0x09, 0x69, 0x73, 0x5f, 0x6d, 0x61, 0x73, 0x74, 0x65, 0x72, 0x18, 0x02, 0x20, 0x01, 0x28,
	0x08, 0x52, 0x08, 0x69, 0x73, 0x4d, 0x61, 0x73, 0x74, 0x65, 0x72, 0x32, 0x63, 0x0a, 0x0b, 0x4e,
	0x6f, 0x64, 0x65, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x2b, 0x0a, 0x08, 0x52, 0x65,
	0x67, 0x69, 0x73, 0x74, 0x65, 0x72, 0x12, 0x0d, 0x2e, 0x67, 0x72, 0x70, 0x63, 0x2e, 0x52, 0x65,
...
var file_services_node_service_proto_goTypes = []interface{}{
	(*NodeResponse)(nil), // 0: grpc.NodeResponse
...
var file_services_node_service_proto_depIdxs = []int32{
	2, // 0: grpc.NodeService.Register:input_type -> grpc.Request
	2, // 1: grpc.NodeService.Ping:input_type -> grpc.Request
	3, // 2: grpc.NodeService.Register:output_type -> grpc.Response
	3, // 3: grpc.NodeService.Ping:output_type -> grpc.Response
...
func file_services_node_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_services_node_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_services_node_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
