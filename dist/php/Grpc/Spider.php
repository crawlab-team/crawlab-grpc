...
/**
 * Generated from protobuf message <code>grpc.Spider</code>
 */
class Spider extends \Google\Protobuf\Internal\Message
{
    ...
    protected $col = '';
    /**
     * Generated from protobuf field <code>repeated .grpc.Env envs = 8;</code>
     */
    private $envs;
    /**
     ...
     *     @type string $type
     *     @type string $col
     *     @type \Grpc\Env[]|\Google\Protobuf\Internal\RepeatedField $envs
     *     @type string $remark
    ...
    /**
     * Generated from protobuf field <code>repeated .grpc.Env envs = 8;</code>
     * @param \Grpc\Env[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setEnvs($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Grpc\Env::class);
        $this->envs = $arr;
