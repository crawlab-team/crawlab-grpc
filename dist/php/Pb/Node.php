...
/**
 * Generated from protobuf message <code>pb.Node</code>
 */
class Node extends \Google\Protobuf\Internal\Message
{
    ...
    protected $key = '';
    /**
     * Generated from protobuf field <code>.pb.NodeSettings settings = 10;</code>
     */
    ...
    /**
     * Generated from protobuf field <code>.pb.NodeSettings settings = 10;</code>
     * @param \Pb\NodeSettings $var
     * @return $this
     */
    public function setSettings($var)
    {
        GPBUtil::checkMessage($var, \Pb\NodeSettings::class);
        $this->settings = $var;
