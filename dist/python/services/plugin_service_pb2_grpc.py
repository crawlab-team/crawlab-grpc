...
if _version_not_supported:
    warnings.warn(
        ...
        + f' but the generated code in services/plugin_service_pb2_grpc.py depends on'
...
def add_PluginServiceServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('grpc.PluginService', rpc_method_handlers)
