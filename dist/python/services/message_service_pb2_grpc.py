...
if _version_not_supported:
    warnings.warn(
        ...
        + f' but the generated code in services/message_service_pb2_grpc.py depends on'
...
def add_MessageServiceServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('grpc.MessageService', rpc_method_handlers)
