...
goog.provide('proto.grpc.Node');

goog.require('jspb.BinaryReader');
goog.require('jspb.BinaryWriter');
goog.require('jspb.Message');
goog.require('proto.grpc.NodeSettings');
...
proto.grpc.Node.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    settings: (f = msg.getSettings()) && proto.grpc.NodeSettings.toObject(includeInstance, f),
...
proto.grpc.Node.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 9:
      ...
      break;
    case 10:
      var value = new proto.grpc.NodeSettings;
      reader.readMessage(value,proto.grpc.NodeSettings.deserializeBinaryFromReader);
...
proto.grpc.Node.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      10,
      f,
      proto.grpc.NodeSettings.serializeBinaryToWriter
    );
  }
 ...
 */
proto.grpc.Node.prototype.getSettings = function() {
  return /** @type{?proto.grpc.NodeSettings} */ (
    jspb.Message.getWrapperField(this, proto.grpc.NodeSettings, 10));
};


/**
 * @param {?proto.grpc.NodeSettings|undefined} value
 * @return {!proto.grpc.Node} returns this
*/
proto.grpc.Node.prototype.setSettings = function(value) {
 ...
 * @return {!proto.grpc.Node} returns this
 */
proto.grpc.Node.prototype.clearSettings = function() {
 ...
 * @return {boolean}
 */
proto.grpc.Node.prototype.hasSettings = function() {
